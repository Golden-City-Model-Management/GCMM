    ...
    <Box position='relative' width='90vw' maxWidth='1024px' borderRadius='12px' bgcolor='primary.light'
     px={8} pt={0} pb={5} >
      <Box position='absolute' top='2%' right='2%' >
        <Button onClick={() => {setIsEditing(true)}} variant='text' color='inherit'><EditOutlined />&nbsp;Edit</Button>
      </Box>
      ...
      <Box>
        ...
        <>
          ...
          <Box mx='auto' display='flex' justifyContent='center'>
            <Button onClick={() => { setShowLightbox(true) }} variant='text' color='secondary'>view in lightbox</Button>
          </Box>
        </>
        :
